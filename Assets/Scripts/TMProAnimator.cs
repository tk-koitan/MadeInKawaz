    ...
    IEnumerator AnimateVertexColors()
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                float angle = t * SpeedMultiplier * 360f - phaseAngel * i;
                if (angle < 0f || angle > 180f) angle = 0f;

                Vector3 jitterOffset = new Vector3(0, Mathf.Sin(angle * Mathf.Deg2Rad), 0);
